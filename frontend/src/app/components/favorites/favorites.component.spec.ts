...
describe('FavoritesComponent', () => {
  ...
  it('should load favorites and custom lists on init', () => {
    ...
    const favReq = httpMock.expectOne('http://filmania.ddns.net:8000/api/users/1/favorites');
    expect(favReq.request.method).toBe('GET');
    favReq.flush(mockFavorites);

    const listReq = httpMock.expectOne('http://filmania.ddns.net:8000/api/users/1/lists');
