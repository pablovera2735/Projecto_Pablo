...
describe('MovieForumComponent', () => {
  ...
  it('should initialize movieId and call loadMovieDetails and loadThread', () => {
    ...
    const threadReq = httpMock.expectOne('http://filmania.ddns.net:8000/api/threads/1');
  ...
  it('should post a comment', fakeAsync(() => {
    ...
    const postReq = httpMock.expectOne('http://filmania.ddns.net:8000/api/comments');
  ...
  it('should search movies and update suggestions', () => {
    ...
    const req = httpMock.expectOne('http://filmania.ddns.net:8000/api/movies/search?q=test');
