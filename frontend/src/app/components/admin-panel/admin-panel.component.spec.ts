...
describe('AdminPanelComponent', () => {
  ...
  it('should load users if user is admin', () => {
    ...
    const req = httpMock.expectOne('https://filmania.ddns.net:8000/api/admin/users');
  ...
  it('should promote a user to admin', () => {
    ...
    const req = httpMock.expectOne('https://filmania.ddns.net:8000/api/admin/users/123/make-admin');
  ...
  it('should delete user after confirmation', () => {
    ...
    const req = httpMock.expectOne('https://filmania.ddns.net:8000/api/admin/users/123');
  ...
  it('should not delete user if confirmation is canceled', () => {
    ...
    httpMock.expectNone('https://filmania.ddns.net:8000/api/admin/users/123');
