...
export class UserProfileComponent implements OnInit {
  ...
  loadUserProfile(): void {
    ...
    if (user && token) {
      ...
      this.http.get<any>(`https://filmania.ddns.net:8000/api/user/${user.id}/profile`, { headers })
        .subscribe(response => {
  ...
  loadUserProfileById(id: number): void {
    ...
    this.http.get<any>(`https://filmania.ddns.net:8000/api/user/${id}/profile`, { headers })
      .subscribe(response => {
  ...
  loadComments(): void {
    ...
    this.http.get<any[]>(`https://filmania.ddns.net:8000/api/profile-comments/${user.id}`, { headers })
      .subscribe(response => {
  ...
  submitComment(): void {
    ...
    this.http.post('https://filmania.ddns.net:8000/api/profile-comments', body, { headers })
      .subscribe({
        next: (res: any) => {
  ...
  loadWatchedMovies(): void {
    ...
    this.http.get<any>(`https://filmania.ddns.net:8000/api/watched/${user.id}`, { headers })
      .subscribe({
        next: (response) => {
  ...
  loadFriends(): void {
    ...
    if (user && token) {
      ...
      this.http.get<any>('https://filmania.ddns.net:8000/api/friends', { headers })
        .subscribe(response => {
  ...
  loadFavoriteMovies(): void {
    ...
    this.http.get<any>(`https://filmania.ddns.net:8000/api/favorites/${user.id}`, { headers })
      .subscribe(response => {
  ...
  loadPendingRequests(): void {
    ...
    this.http.get<any[]>('https://filmania.ddns.net:8000/api/friends/pending', { headers })
      .subscribe({
        next: (response) => {
  ...
  acceptRequest(senderId: number): void {
    ...
    this.http.post<any>('https://filmania.ddns.net:8000/api/friends/accept', { sender_id: senderId }, { headers })
      .subscribe(() => {
  ...
  rejectRequest(senderId: number): void {
    ...
    this.http.post<any>('https://filmania.ddns.net:8000/api/friends/reject', { sender_id: senderId }, { headers })
      .subscribe(() => {
        this.pendingRequests = this.pendingRequests.filter(r => r.id !== senderId);
      });
  }
  ...
  uploadPhoto(event: any): void {
    ...
    this.http.post<any>('https://filmania.ddns.net:8000/api/profile/upload-photo', formData, { headers })
      .subscribe(response => {
        if (response.profile_photo) {
          this.profilePhoto = 'https://filmania.ddns.net:8000/' + response.profile_photo;
  ...
  deletePhoto(): void {
    ...
    this.http.delete<any>('https://filmania.ddns.net:8000/api/profile/delete-photo', { headers })
      .subscribe(response => {
        if (response.profile_photo) {
