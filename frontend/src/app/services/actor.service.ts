...
export class ActorService {
  private apiUrl = 'http://filmania.ddns.net:8000/api'; // Cambia esto si tu backend está en otra ruta

  constructor(private http: HttpClient) {}

  // Obtener actores, actrices, directores etc populares
  getPopularPeople(page: number = 1): Observable<any> {
    return this.http.get<any>(`http://filmania.ddns.net:8000/api/people/popular?page=${page}`);
  }
